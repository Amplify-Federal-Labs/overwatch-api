/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 13ed020bbe592516480eb99fc2d22399)
// Runtime types generated with workerd@1.20260210.0 2025-10-08 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ObservationExtractorAgent" | "EntityResolverAgent" | "SynthesisAgent";
	}
	interface Env {
		DB: D1Database;
		CF_AIG_TOKEN: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CF_AIG_TOKEN" | "CF_AIG_BASEURL" | "CF_AIG_MODEL" | "BRAVE_SEARCH_API_KEY" | "LOG_LEVEL">> {}
}
