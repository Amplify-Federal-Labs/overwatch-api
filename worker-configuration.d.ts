/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a7dab9a66b180876b1a43c8ffa17f238)
// Runtime types generated with workerd@1.20260301.1 2025-10-08 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ObservationExtractorAgent" | "EntityResolverAgent" | "SynthesisAgent" | "SignalMaterializerAgent" | "EnrichmentAgent";
	}
	interface Env {
		DB: D1Database;
		CF_AIG_TOKEN: string;
		...
		SYNTHESIS: DurableObjectNamespace<import("./src/index").SynthesisAgent>;
		SIGNAL_MATERIALIZER: DurableObjectNamespace<import("./src/index").SignalMaterializerAgent>;
		ENRICHMENT: DurableObjectNamespace<import("./src/index").EnrichmentAgent>;
	}
}
